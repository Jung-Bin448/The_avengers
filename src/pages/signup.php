...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($usernameInput) && !empty($email) && !empty($userPassword) && !empty($confirmPassword)) {
        if ($userPassword !== $confirmPassword) {
            ...
            // Direct redirect to the Today's Quests Dashboard
...
<body>
    ...
    <div class="login-container">
        ...
        <form action="signup.php" method="POST">
            ...
            <div class="input-group">
                <div class="label-row"><label for="confirm_password">Confirm Password</label></div>
                <div class="input-box">
                    <i class="fa-solid fa-lock"></i>
        ...
        <div class="social-login">
            <button class="social-button" id="googleButton" type="button" onclick="window.location.href='dashboard.php'">
            ...
            <button class="social-button" id="facebookButton" type="button" onclick="window.location.href='dashboard.php'">
